...
=========
# Deploy the infrastructure we need for the demo
...
[F5 -0- AWS -Gather specific facts](https://gitlab.com/mlowcher/F5_examples/-/blob/master/0_bigip_facts.yml?ref_type=heads "")<br>
